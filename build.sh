...
openssl req -passin env:ca_pas -passout env:ca_pas -config $INTERMEDIATE_CA/openssl.cnf -new -sha256 \
...
openssl ca -passin env:ca_pas -batch -config $ROOT_CA/openssl.cnf -extensions v3_intermediate_ca -days 1825 \
